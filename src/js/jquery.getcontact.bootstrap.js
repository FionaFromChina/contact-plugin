+(function($,window,document,undefined) {
    ...
    var old = $.fn.terminalSelect;

    $.fn.terminalSelect             = ContactDialog;
    $.fn.terminalSelect.Constructor = TerminalSelect;


    // MODAL NO CONFLICT
    // =================

    $.fn.terminalSelect.noConflict = function () {
        $.fn.terminalSelect = old;
        return this
    };
    ...
    $.fn.terminalSelect = function(options) {
        ...
        if(TerminalSelect[options]) {
            return TerminalSelect[options].apply(this,Array.prototype.slice.call(arguments,1));
        }else if(typeof options === 'object' || !options) {
            //return TerminalSelect.apply(this,arguments);
            var ter = new TerminalSelect(this,options);
            return ter.init();
        }else {
            $.error('Method ' + options + 'does not exist on jQuery.terminalSelect');
        }
    }
